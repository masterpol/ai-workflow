# Sub-pitch: caveman-metrics-compression
...
Deliver one bounded part of [portable-skill-defaults](pitch.md).
...
Stats integration, metrics deduplication and explicit compression safeguards.
