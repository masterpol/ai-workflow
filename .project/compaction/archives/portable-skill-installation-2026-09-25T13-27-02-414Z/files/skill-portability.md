...
Deliver one bounded part of [portable-skill-installation](pitch.md).
...
All project-available vendor adapters, sync migration, doctor, scoped formatting and two-instance tests, including a fixture with an additional registered project vendor.
