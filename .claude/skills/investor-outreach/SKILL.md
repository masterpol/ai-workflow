...
> **Recommended capability profile:** `standard` — audience-specific personalization judgment. Select an available model using `ai-framework/integrations/harnesses.md`.
