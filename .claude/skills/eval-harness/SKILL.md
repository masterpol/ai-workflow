...
> **Recommended capability profile:** `standard` — eval design and harness judgment. Select an available model using `ai-framework/integrations/harnesses.md`.
...
```
Creates eval definition file at `.project/evals/feature-name.md`
