...
Check `ai-framework/rules/testing.md` for the stack-agnostic principle and this project's
`.project/rules/*.md` companions for its actual test runner, file-naming convention, and
coverage expectations (e.g. `.project/context/stack.md`'s "Key scripts" table names the real
test command) before writing tests — don't assume a generic runner or naming scheme.
